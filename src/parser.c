...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_entry] = STATE(3),
    [sym_entrySimple] = STATE(22),
    [sym_entryArray] = STATE(22),
    [sym_class] = STATE(22),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entrySimple, 4, 0, 2),
  [63] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_entrySimple, 4, 0, 2),
  ...
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entryArray, 5, 0, 4),
  [83] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_entryArray, 5, 0, 4),
  ...
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entry, 1, 0, 0),
  [95] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_entry, 1, 0, 0),
